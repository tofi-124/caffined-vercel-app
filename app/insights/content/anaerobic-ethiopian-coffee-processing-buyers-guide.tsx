  ...
  return (
    <>
      ...
      <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
        ...
        <p className='my-2'>
          As an experienced Ethiopian coffee exporter, <span className='font-bold'>Ethio Coffee Export PLC</span> works with washing stations in Yirgacheffe, Guji, and Sidamo that produce documented anaerobic and honey process lots. Our sourcing network, built over 30 years of heritage relationships across Ethiopia&apos;s growing regions, gives us direct access to washing station operators investing in experimental processing. We provide full fermentation protocol documentation, cupping reports, and traceability records for every experimental lot we offer. Contact us to request current offers, samples, and pricing for Ethiopian anaerobic and honey process lots.
        </p>

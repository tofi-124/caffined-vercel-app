  ...
  return (
    <>
          ...
          <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
            ...
            <p className='my-2'>
              As a quality-focused Ethiopian coffee exporter, <span className='font-bold'>Ethio Coffee Import and Export PLC</span> welcomes detailed QC discussions. Experience Ethiopian coffee quality firsthand with samples, specifications, and transparent quality reporting.
            </p>

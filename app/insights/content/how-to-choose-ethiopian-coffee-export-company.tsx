    ...
    <>
      ...
      <div className='bg-red-50 p-6 rounded-lg my-6 border border-red-200'>
        ...
        <ul className='list-disc ml-5 space-y-2'>
          ...
          <li><span className='font-bold'>Prices significantly below market.</span> Ethiopian green coffee has a floor price influenced by the C-market, differentials, and local cherry costs. An offer 20% or more below comparable quotes likely means the exporter will substitute lower-grade lots, delay shipment until prices move in their favor, or default entirely.</li>
      ...
      <ol className='font-inconsolata my-4 list-decimal ml-5'>
        <li className='my-3'>
          <span className='font-bold'>Define your requirements before reaching out.</span> Document the grades you need (Grade 1 specialty, Grade 2, or commercial Grade 3-4), preferred processing methods (washed or natural), target volume (bags or containers per year), and preferred Incoterms (FOB Djibouti, CIF). Clear requirements filter out exporters who cannot serve your needs.
        </li>
        <li className='my-3'>
      ...
      <p className='my-4'>
        Ethiopian green coffee is priced as a differential above the New York C-market (ICE Arabica futures). The differential varies by region, grade, processing method, and season. As of early 2026, Ethiopian differentials have been elevated due to rising cherry prices (local costs exceeding 250 birr per kilogram in some regions), increased global demand for specialty lots, and supply tightness in Grade 1 washed categories.
      </p>
      <p className='my-4'>
        A transparent exporter will break down the FOB price into its components: C-market reference, differential, and any applicable certification premiums. If an exporter only quotes a flat number without explanation, ask for the breakdown. Our <Link href='/insights/ethiopian-coffee-pricing-fob-guide' className='underline font-bold'>Ethiopian coffee pricing and FOB guide</Link> provides current indicative price ranges and explains every component in detail.
      </p>

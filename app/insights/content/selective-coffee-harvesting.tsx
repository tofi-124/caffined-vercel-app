  ...
  return (
    <>
      ...
      <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
        ...
        <p className='my-2'>
          At <span className='font-bold'>Ethio Coffee Import and Export PLC</span>, our specialty lots are hand-picked at peak ripeness for maximum cup quality. Request samples today.
        </p>

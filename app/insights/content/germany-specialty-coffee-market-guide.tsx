    ...
    <>
      ...
      <div className='border-t border-gray-300 mt-10 pt-6'>
        <p className='text-sm text-gray-600 font-inconsolata'>
          <span className='font-bold'>About This Insight:</span> Published by Ethio Coffee Export PLC. This market analysis covers the German specialty coffee market for Ethiopian exporters, including buyer segments, origin-market fit, competitive positioning, certification requirements, pricing strategy, and business development guidance. Market conditions change; <Link href='/contact-us' className='underline'>contact us</Link> for current pricing, availability, and regulatory updates.
        </p>

  ...
  return (
    <>
      ...
      <ol className='list-decimal pl-6 my-4 space-y-3'>
        ...
        <li><span className='font-bold'>Understand pricing structure.</span> Ethiopian coffee is typically priced as a differential above the New York C-market. Specialty micro-lots may be priced as a flat FOB rate. Make sure you understand which model applies to your purchase. <Link href='/insights/ethiopian-coffee-pricing-fob-guide' className='underline font-semibold'>Read our pricing guide</Link> for a full breakdown.</li>

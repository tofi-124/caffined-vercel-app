    ...
    <>
      ...
      <div className='border-t border-gray-300 mt-10 pt-6'>
        <p className='text-sm text-gray-600 font-inconsolata'>
          <span className='font-bold'>About This Insight:</span> Published by Ethio Coffee Export PLC. Brewing temperatures reference SCA standards. For current product availability, pricing, and sample requests, please contact our team directly.
        </p>

  ...
  return (
    <>
      ...
      <p className='my-4'>
        ...
        For a deeper look at how these coffees are cultivated from farm to export, explore our guide to <Link href='/insights/coffee-is-agriculture-production-farming' className='text-amber-700 hover:underline font-bold'>coffee agriculture and production in Ethiopia</Link>.
      </p>
      ...
      <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
        ...
        <p className='my-2'>
          As a trusted Ethiopian coffee exporter, <span className='font-bold'>Ethio Coffee Import and Export PLC</span> can recommend lots based on your target profile and share traceability details. From floral Yirgacheffe to bold Harrar, we export across all major Ethiopian origins.
        </p>

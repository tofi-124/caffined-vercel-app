  ...
  return (
    <>
          ...
          <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
            <h4 className='font-bold text-xl mb-3'>Experience the Science of Ethiopian Coffee</h4>
            <p className='my-2'>
              At <span className='font-bold'>Ethio Coffee Export PLC</span>, learn about our rigorous quality evaluation and sourcing process for exceptional Ethiopian coffees.
            </p>

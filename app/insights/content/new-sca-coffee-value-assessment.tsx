  ...
  return (
    <>
      ...
      <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
        ...
        <p className='my-2'>
          At <span className='font-bold'>Ethio Coffee Export PLC</span>, we provide full value assessment data on all our specialty lots. Request samples and see how our coffees perform under the new framework.
        </p>

...
export default function ImportingEthiopianCoffeeToHolland({ title, date, large_image_url }: InsightContentProps) {
  return (
    <>
      ...
      <p className='my-4'>
        As an ECX-registered Ethiopian coffee exporter with three decades of sourcing heritage, Ethio Coffee Export PLC works with Dutch importers, roasters, and traders who source specialty Ethiopian coffee through Rotterdam:
      </p>
      ...
      <div className='bg-amber-50 p-6 rounded-lg my-8 border border-amber-200'>
        ...
        <p className='my-2'>
          <span className='font-bold'>Ethio Coffee Export PLC</span> is an origin-connected Ethiopian exporter with three decades of sourcing heritage. We work with trusted cooperatives and washing stations across Yirgacheffe, Guji, Sidamo, and other Ethiopian coffee regions to deliver specialty-grade green coffee to Dutch importers and European roasters. Our team handles all Ethiopian export documentation, quality testing, and FOB Djibouti shipping coordination.
        </p>

  ...
  return (
    <>
      ...
      <h3 className='text-3xl font-extrabold mt-12 mb-6'>
        Conclusion: Australia – The World's Most Quality-Obsessed Coffee Market
      </h3>
      ...
      <div className='my-8 p-6 bg-gray-50 rounded-lg border border-gray-200'>
        ...
        <ul className='space-y-2 text-sm'>
          ...
          <li>
            <Link href='/insights/importing-ethiopian-coffee-to-south-korea' className='text-amber-700 hover:underline'>
              → Importing Ethiopian Coffee to South Korea: Complete Market Guide
            </Link>
          </li>
          <li>
            <Link href='/insights/importing-ethiopian-coffee-to-uk' className='text-amber-700 hover:underline'>
              → Importing Ethiopian Coffee to UK: Complete Post-Brexit Guide
            </Link>
          </li>
          <li>

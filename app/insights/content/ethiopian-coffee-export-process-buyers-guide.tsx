        ...
        <div className='grid md:grid-cols-2 gap-6'>
          <div>
            ...
            <ul className='space-y-1 text-sm'>
              ...
              <li>• <Link href='/insights/green-coffee-financing-hedging-importers-guide' className='text-amber-700 hover:underline'>Green Coffee Price Hedging: Importer's Guide</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className='space-y-1 text-sm'>
              ...
              <li>• <Link href='/insights/private-vs-cooperative-ethiopian-coffee-exporters' className='text-amber-700 hover:underline'>Private vs. Cooperative Coffee Exporters</Link></li>
            </ul>
          </div>
          <div>

...
const readingTimeMap: Record<string, number> = {
  ...
  'rising-ethiopian-coffee-prices-explained': 30,
  'private-vs-cooperative-ethiopian-coffee-exporters': 18,
  'how-to-import-ethiopian-coffee-to-usa': 16,
  'importing-ethiopian-coffee-to-canada-guide': 18,
  'importing-ethiopian-coffee-to-saudi-arabia': 20,
  'importing-ethiopian-coffee-to-uae': 21,
  'importing-ethiopian-coffee-to-south-korea': 30,
  'importing-ethiopian-coffee-to-japan': 20,
  'importing-ethiopian-coffee-to-germany': 21,
  'importing-ethiopian-coffee-to-holland': 16,
  'importing-ethiopian-coffee-to-uk': 30,
  'importing-ethiopian-coffee-to-australia': 32,
  'ecx-and-ethiopian-coffee-export': 14,
  'top-10-specialty-coffee-shops-world': 14,
  'new-sca-coffee-value-assessment': 14,
  ...
  'ethiopian-coffee-certifications-organic-fairtrade-rainforest': 38,
  'ethiopian-heirloom-coffee-varieties-landraces': 34,
  'minimum-order-quantities-ethiopian-coffee-moq': 34,
  ...
  'guide-ethiopian-coffee-origins': 12,
  'yirgacheffe-vs-sidamo-vs-guji-comparison': 16,
  'washed-vs-natural-ethiopian-coffee-processing': 16,
  ...
  'how-to-roast-ethiopian-coffee-guide': 20,
}

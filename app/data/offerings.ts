...
export const offerings: Offering[] = [
  {
    ...
    specifications: {
      ...
      harvestPeriod: 'November 2025 - February 2026',
    ...
    pricing: {
      ...
      sampleOptions: [
        { weight: '100g', weightGrams: 100, priceUSD: 0, description: 'Cupping sample' },
        { weight: '300g', weightGrams: 300, priceUSD: 0, description: 'Roast trial sample' },
      ],
    },
    isSoldOut: false,

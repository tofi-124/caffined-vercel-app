  ...
  return (
    <>
      ...
      <div className='space-y-4'>
        ...
        <p className='text-gray-700 text-sm leading-relaxed'>
          Her turning point came through the Coffee Training Center (CTC) of the Ethiopian Coffee and Tea Authority, a state-of-the-art facility implemented by <strong>UNIDO</strong> and funded by the <strong>Italian Agency for Development Cooperation (AICS)</strong>. The CTC forms part of a broader initiative to strengthen Ethiopia&apos;s coffee value chain and promote sustainable job creation across the sector.
        </p>
        <p className='text-gray-700 text-sm leading-relaxed'>
        ...
        <p className='text-gray-700 text-sm leading-relaxed italic border-l-4 border-amber-400 pl-4'>
          &ldquo;The Coffee Training Center was more than just a school. It was where my dreams began to take shape. The instructors encouraged me to ask questions, practice constantly, and believe in myself. Coffee is not just a drink. It&apos;s a culture, a livelihood, and now, it&apos;s my future.&rdquo;
        ...
        <p className='text-gray-700 text-sm leading-relaxed italic border-l-4 border-amber-400 pl-4'>
          &ldquo;Life can be full of difficulties. But it can also be full of hope. My dream has come true, and I am just getting started. Long live coffee, and long live empowered women.&rdquo;
          <span className='block mt-1 not-italic text-gray-500'>- Mulunesh Chekol Maru</span>
        </p>

        ...
        <div className='max-w-4xl mx-auto px-6'>
          ...
          <div className='space-y-6'>
            {[
              ...
              { q: 'What is the minimum order quantity?', a: 'Standard minimum orders are one full container load (FCL) of approximately 300 bags at 60kg each (roughly 20 metric tons / 44,000 lbs). You can mix origins and grades to fill a container. We also offer affordable 300g evaluation samples that you can purchase directly from any product page to evaluate cup quality before committing.' },

      ...
      <section className='relative bg-dark text-primary py-20 md:py-28'>
        <div className='max-w-5xl mx-auto px-6 text-center'>
          ...
          <p className='text-lg md:text-xl text-primary/80 max-w-3xl mx-auto leading-relaxed'>
            Complex berry-forward coffees with wine-like acidity and a rich mouthfeel.
            Sidamo is one of Ethiopia&apos;s largest and most versatile specialty coffee regions,
            producing both exceptional washed and world-class natural lots.
          </p>
